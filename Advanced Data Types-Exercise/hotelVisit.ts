...
type simplified = {number: 1, train: () => void} & ({hallway: 'A', pass?: 'Guest'} | {hallway: 'C'}) | 
{number: 2, dine: () => void} & ({hallway: 'A', pass?: 'Guest'} | {hallway: 'C'}) |
{number: 3, sleep: () => void, hallway: 'A' | 'C'}



function visitFloor(floor: simplified) {
    switch (floor.number) {
        case 1: floor.train(); return 'Train function called';
        case 2: floor.dine(); return 'Dine function called';
        case 3: floor.sleep(); return 'Sleep function called';
    }
}
